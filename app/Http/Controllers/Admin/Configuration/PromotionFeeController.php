...
class PromotionFeeController extends Controller
{
    public function addFeeForm()
    {
        ...
        return view('admin.configuration.promotionFee.add_new_fee_form',compact('fee_type'));
    }
    ...
    public function searchFees(Request $request)
    {
        ...
        $fees_total = DB::table('admsn_fee_structure')
            ...
            ->where('admsn_fee_structure.class_id',$request->input('class'))
            ->sum('amount');
        return view('admin.configuration.promotionFee.fee_list',compact('fees_search','fees_total','class_name','medium') );
    }

    public function FeeEditForm($class_id,$medium)
    {
        try {
        ...
        return view('admin.configuration.promotionFee.fee_edit_form',compact('fees','class_list','medium','class_id','amount'));
    }
