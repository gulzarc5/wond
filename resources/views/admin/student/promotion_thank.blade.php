    ...
    <div class="row" style="display:flex;justify-content:center" id="print_div">
        <div class="col-md-10 col-sm-10 col-xs-12" style="background-color: white; text-align:center">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <h4 style="padding: 5px;margin-buttom: 5px;margin-top: 0px;">Promotion Receipt</h4>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    <tr>
                        <td>Promotion Fees</td>
                        <td>{{ number_format($prmsn->fees_amount,2,".",'') }}</td>
                    </tr>
                    <tr>
                        <td>Scholarship Amount</td>
                        <td>{{ number_format($prmsn->discount,2,".",'') }}</td>
                    </tr>
                    <tr>
                        <td>Paid Amount</td>
                        <td>{{ number_format($prmsn->receive_amount,2,".",'') }}</td>
                    </tr>
                    <tr>
                        <td>Balance Amount</td>
                        <td>{{ number_format($prmsn->pending_amount,2,".",'') }}</td>
                    </tr>
                </table>
            </div>
            @endif
            ...
            <div class="col-md-12 col-sm-12" id="div-hid">
                ...
                <a href="{{route('admin.student_promote')}}" class="btn btn-sm btn-warning">Back</a>
            </div>
