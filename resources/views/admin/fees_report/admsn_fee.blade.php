    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:50px;">
            <div class="x_panel">
                ...
                <div>
                    <div class="x_content">
                        {{ Form::open(['method' => 'post','route'=>'admin.admsn_fee_report_search']) }}
                            ...
                            <div class="form-row mb-10">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                    <input class="btn btn-success" type="submit" value="Search" style="margin-top: 23px;width: 116px;">
                                </div>
     ...
     <script type="text/javascript">
         $(function () {    
            var table = $('#size_list').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.admsn_fee_report_ajax') }}",
                columns: [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 's_student_id', name: 's_student_id',searchable: true},
