            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                ...
                                @foreach ($fees as $item)
                                    ...
                                    <td>
                                        <a href="{{route('admin.admsn_fee_edit_form',['class_id'=>encrypt($item['class_id']),'medium'=>encrypt($item['medium'])])}}" class="btn btn-warning">Edit</a>
                                    </td>
                                    </tr>                              
                                @endforeach
                        ...
                        <h2>Admission Fee Details Of Class {{$class_name->name}} in 
                            @if ($medium == 1)
                                Bengali
                            @else
                                English
